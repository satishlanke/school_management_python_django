# Student Management System Created Using Python Django
...
```
$  git clone https://github.com/satishlanke/school_management_python_django.git

```

Then, Enter the project
```
$  cd school_management_python_django
```
